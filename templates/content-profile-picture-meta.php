<?php
/* 
 * This file processes requests to view/edit the speaker's profile picture uploads.
 * cfc slug is 'profile-picture-meta'
 * Provide link to Speaker-Bio Archive page for Admin and Editors.
 *
 */

$ignore_fields_titles = array( 'Unique ID' , 'Status'  , 'Notes' );
		...
		foreach( $this_speaker_cfc_form['fields'] as $this_cfc_form_field ) {
			...
			switch ($this_cfc_form_field['field-type']) {
				...
				case 'checkbox':
					...
					break;
				default:
					idies_debug("Unknown Field Type: ". $this_cfc_form_field['field-type']);
			}
